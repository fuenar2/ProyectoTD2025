...
author: "Mar Fuentes Armenteros, Paula Girbés Plaza, Pablo Fernando Navarro Sánchez,
  Andreu Serrano Briz, Hugo Cuñat Alabau y Rafael Cebrián Pérez"
date: "2025-05-10"
output:
...
adquiridos, precios y comportamiento de compra. A través del
procesamiento de estos tickets utilizando el lenguaje de programación R,
se ha diseñado un sistema capaz de leer automáticamente la información
contenida en los comprobantes de compra y estructurarla en un data frame
que facilite su análisis posterior. Este enfoque permite aplicar
técnicas de limpieza, transformación y visualización de datos sobre un
conjunto no estructurado, como lo es una imagen o texto plano de un
ticket., que permiten reducir gastos a la hora de utilizar conjuntos
masivos de datos. 
