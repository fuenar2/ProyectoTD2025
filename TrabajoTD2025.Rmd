...
library(dplyr)
library(arules)
# Asegurarse de que tickets_df contiene la información correcta
# Aquí, asumimos que tickets_df tiene columnas: 'ticket_id' y 'producto'
# Creamos un dataframe con transacciones para el análisis de cesta de la compra
...
summary(transacciones_list)
# Aplicar el algoritmo Apriori para encontrar combinaciones frecuentes
# Minimos de soporte y confianza para las reglas de asociación
reglas <- apriori(transacciones_list, parameter = list(supp = 0.01, conf = 0.5))
# Ver las reglas generadas
inspect(reglas)
# Filtrar las reglas más interesantes, si es necesario
reglas_interesantes <- subset(reglas, lift > 1.5)  # Reglas con lift mayor a 1.5, que indica más asociación
