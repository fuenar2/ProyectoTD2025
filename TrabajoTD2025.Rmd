...
# Gráfico de barras
ggplot(fv_top5, aes(x = reorder(producto, kilos_vendidos), y = kilos_vendidos)) +
  geom_bar(stat = "identity", fill = "darkgreen") +
  coord_flip() +
  labs(title = "Top 5 productos de frutas y verduras más vendidos",
       subtitle = "Según kilos vendidos",
       x = "Producto",
       y = "Kilos vendidos")
