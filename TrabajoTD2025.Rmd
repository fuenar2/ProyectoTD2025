...
# Conclusiones
```{r}
# Agregar la columna 'semana' y calcular las unidades vendidas por producto cada semana
...
# Identificar productos con mayor y menor rotación sumando las unidades vendidas
rotacion_total <- rotacion_semanal %>%
  group_by(producto) %>%
  summarise(total_unidades_vendidas = sum(unidades_vendidas)) %>%
  ungroup()

# Mostrar los 10 productos con mayor y menor rotación
list(
